        ...
        <Link href="/panduan" className="block">
          ...
          >
            <div className="flex flex-col items-center gap-6 px-8 py-12 sm:flex-row sm:gap-10 sm:px-12 sm:py-14">
              ...
              {/* CTA Button */}
              <span className="inline-flex items-center gap-2 rounded-full bg-primary-600 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-primary-600/30 transition-all duration-200 group-hover:bg-primary-700 group-hover:shadow-xl group-hover:-translate-y-0.5 shrink-0">
